#ifndef Kompas_PluginManager_Test_AbstractFood_h
#define Kompas_PluginManager_Test_AbstractFood_h
/*
...
class AbstractFood: public Plugin {
    PLUGIN_INTERFACE("cz.mosra.Kompas.PluginManager.Test.AbstractFood/1.0")
